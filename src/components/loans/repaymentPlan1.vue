        ...
        <div v-if="show" class="repayment_plan_container" :style="{top:top}">
            ...
            <div class="repayment_plan_content">
                ...
                <scroller class="scroller" style="flex: 1;">
                    <div class="scroller1" v-for="(item,key) in planList" :key="key">
                        <text class="repayment_plan_content_text1">{{item.ScheduledPaymentDate | sub}}</text>
                        <text class="repayment_plan_content_text">{{item.PayPrincipalAmt | addDot}}</text>
                        <text class="repayment_plan_content_text">{{item.PayInterestAmt | addDot}}</text>
                        <text class="repayment_plan_content_text2">{{item.PayTotalAmt | addDot}}</text>
                        <!-- <text class="repayment_plan_content_text1">343242</text>
                        <text class="repayment_plan_content_text">234324</text>
                        <text class="repayment_plan_content_text">234242</text>
                        <text class="repayment_plan_content_text2">2342342</text> -->
                    </div>
